...
export const metadata: Metadata = {
  ...
  description:
    "Une question, une suggestion ou besoin d'aide ? Contactez l'équipe InkStudio. Nous sommes là pour vous accompagner.",
  keywords: [
    "contact",
    "InkStudio",
    "support",
        ...
        <div className="container mx-auto px-4 sm:px-8 max-w-4xl relative z-10">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-tertiary-500/10 border border-tertiary-400/20 rounded-full px-4 py-2 mb-6">
              <FaEnvelope size={16} className="text-tertiary-400" />
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 rounded-2xl p-6">
                    ...
                    <p className="text-white/80 font-one text-sm leading-relaxed">
                      ...
                      "Inscription salon" ou envoyez-nous un email directement.
                      Nous vous guiderons dans le processus.
                    </p>
                  </div>
                  ...
                  <div className="bg-white/5 rounded-2xl p-6">
                    ...
                    <p className="text-white/80 font-one text-sm leading-relaxed">
                      ...
                      maximum. Les demandes urgentes sont traitées en priorité.
                    </p>
                  </div>
                </div>
              </div>
